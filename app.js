(function () {
  ...
  function renderCoverage() {
    var html =
      '<ul>' +
      '<li><strong>ACJS (careers.acjs.org)</strong> — both public pages of the careers board collected on June 15, 2026. After applying the criminology / criminal-justice relevance filter, 3 specific postings retained; the rest excluded as adjunct-pool catch-alls, EMT / paramedic / paralegal, generic auxiliary-services roles, or unrelated counseling postings. Posted dates were given as relative ("X days ago") and converted to absolute dates relative to capture date.</li>' +
      '<li><strong>ASC (asc41.org)</strong> — single static page, no pagination, captured June 15, 2026. All 4 publicly listed postings captured.</li>' +
      '<li><strong>HigherEdJobs (higheredjobs.com)</strong> — Criminal Justice & Criminology faculty category, first 50 active postings captured (June 15, 2026). 12 retained as faculty + research roles (assistant/associate professors, lecturers, instructors, visiting faculty, teaching faculty); the rest excluded as adjunct, part-time, instructor pools, dual-credit, police-academy training, or non-criminology forensic-science/homeland-security postings.</li>' +
      '<li><strong>jobs.ac.uk</strong> — the keyword=criminology search captured June 15, 2026; 7 retained as clearly criminology-relevant (including criminology-adjacent sociology, policing, and law posts housed in criminology departments). The remainder excluded as pure law-school lectureships, generic methodology fellowships, or unrelated technician/editor roles.</li>' +
